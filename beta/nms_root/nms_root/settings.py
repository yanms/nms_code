...
DATABASES = {
    'default': {
        ...
        'NAME': '/var/www/django/nms_code/beta/nms_root/nms.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '5xi3u!5r(v5)l9#34_ly0d=2@0an*wgm4gyy-)tllcbhpg6=9i'
...
ROOT_URLCONF = 'nms_root.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'nms_root.wsgi.application'
