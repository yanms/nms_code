...
class BufferedFileTest (unittest.TestCase):
    ...
    def test_2_readline(self):
        ...
        # truncated line:
        self.assertEqual(f.readline(7), b'Third l')
        self.assertEqual(f.readline(), b'ine.\n')
        self.assertEqual(f.readline(), b'Final line non-terminated.')
        ...
        self.assert_(b'\n' in f.newlines)
        self.assert_(b'\r\n' in f.newlines)
        self.assert_(b'\r' not in f.newlines)
    ...
    def test_3_lf(self):
        ...
        self.assertEqual(f.readline(), b'First line.\n')
        f.write(b'\nSecond.\r\n')
        self.assertEqual(f.readline(), b'Second.\n')
        f.close()
        self.assertEqual(f.newlines, b'\r\n')
    ...
    def test_4_write(self):
        ...
        self.assertEqual(f.readline(), b'Complete line.\n')
        self.assertEqual(f.readline(), b'')
        f.write(b'..\n')
        self.assertEqual(f.readline(), b'Incomplete line...\n')
        f.close()
